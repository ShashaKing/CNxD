...
def cnr_learn_parm(train_dataset, data_name, tum_dir, tum_name, depth):
    
    
    print ('-----Learning parameters from GIVEN structure----')
    module_dir = '../rcn_output/'
...
"""
def cnr_tune_paramter(train_dataset, valid_dataset, test_dataset, data_name, depth):
...
def main_rcn_parm():
    ...
    cnr_learn_parm(train_dataset, data_name, tum_dir, tum_name, depth)
    cnr_tune_paramter(train_dataset, valid_dataset, test_dataset, data_name, depth)
...
if __name__=="__main__":
    ...
    start = time.time() 
    print('------------------------------------------------------------------')
    print('Learning a Deep Random Cutset Network')
    print('------------------------------------------------------------------')
    purpose = sys.argv[2] 
    if purpose == 'structure':    
        ...
        print ('****EROOR: must be structure learning or parameter learning****')
        exit()
